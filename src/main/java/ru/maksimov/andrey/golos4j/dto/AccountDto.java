...
public class AccountDto implements Serializable {
    ...
    private int benefactionRewards;
    ...
    private String lifetimeMarketBandwidth;
    ...
    private int postsCapacity;
    private int commentsCapacity;
    ...
    public long getDelegationRewards() {
        return delegationRewards;
    }

    public int getBenefactionRewards() {
        return benefactionRewards;
    }
    ...
    public String getLifetimeMarketBandwidth() {
    ...
    public int getPostsCapacity() {
        return postsCapacity;
    }

    public int getCommentsCapacity() {
        return commentsCapacity;
    }
    ...
    public int getReferrerInterestRate() {
        return referrerInterestRate;
    }
    ...
    public Asset getReferralBreakFee() {
        return referralBreakFee;
    }
    ...
    @JsonProperty("delegation_rewards")
    public void setDelegationRewards(long delegationRewards) {
        this.delegationRewards = delegationRewards;
    }

    @JsonProperty("benefaction_rewards")
    public void setBenefactionRewards(int benefactionRewards) {
        this.benefactionRewards = benefactionRewards;
    }
    ...
    public void setLifetimeMarketBandwidth(String lifetimeMarketBandwidth) {
    ...
    @JsonProperty("posts_capacity")
    public void setPostsCapacity(int postsCapacity) {
        this.postsCapacity = postsCapacity;
    }

    @JsonProperty("comments_capacity")
    public void setCommentsCapacity(int commentsCapacity) {
        this.commentsCapacity = commentsCapacity;
    }

    @JsonProperty("voting_capacity")
    public void setVotingCapacity(int votingCapacity) {
        this.votingCapacity = votingCapacity;
    }

    @JsonProperty("referrer_account")
    public void setReferrerAccount(String referrerAccount) {
        this.referrerAccount = referrerAccount;
    }

    @JsonProperty("referrer_interest_rate")
    public void setReferrerInterestRate(int referrerInterestRate) {
        this.referrerInterestRate = referrerInterestRate;
    }

    @JsonProperty("referral_end_date")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss", timezone = "GMT")
    public void setReferralEndDate(Date referralEndDate) {
        this.referralEndDate = referralEndDate;
    }

    @JsonProperty("referral_break_fee")
    public void setReferralBreakFee(Asset referralBreakFee) {
        this.referralBreakFee = referralBreakFee;
    }
