...
public class DynamicGlobalPropertiesDto extends BaseDto {
    ...
    private int customOpsBandwidthMultiplier;
    ...
    @JsonProperty("custom_ops_bandwidth_multiplier")
    public int getCustomOpsBandwidthMultiplier() {
        return customOpsBandwidthMultiplier;
    }

    public void setCustomOpsBandwidthMultiplier(int customOpsBandwidthMultiplier) {
        this.customOpsBandwidthMultiplier = customOpsBandwidthMultiplier;
    }

    @JsonProperty("is_forced_min_price")
    public boolean isForcedMinPrice() {
        return isForcedMinPrice;
    }

    public void setForcedMinPrice(boolean isForcedMinPrice) {
        this.isForcedMinPrice = isForcedMinPrice;
    }
